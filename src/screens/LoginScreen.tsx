...
export function LoginScreen() {
  ...
  return <KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === 'ios' ? 'padding' : undefined}><Screen>
    <BrandPanel compact title="Bem-vindo à Home Easy" description="Entre para contratar profissionais, conversar e acompanhar seus pedidos." />
